...
#
	## Car now controls camera automatically through Player.gd’s driving flag
...
#
	...
	#player.global_transform.origin = global_transform.origin + Vector3(1,0,1)
#
	## Tell player script that player is no longer driving
	#player.driving = false
#
	#print("Player exited car.")
